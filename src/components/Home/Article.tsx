  ...
  return (
    <article className="my-32 mx-6">
      ...
      <p className="text-[#7B7B7B] mb-4">
        ...
        di masyarakat untuk mengingatkan kepada sesama agar tidak tenggelam atau
        luput dalam menjaga kemajuan ibadahnya.
      </p>

      <p className="text-[#7B7B7B] mb-4">
        Oleh karena itu, kami memberikan visualisasi bagi individu yang telah
        beribadah agar menjadi laporan bagi dirinya sendiri, seberapa dekat atau
        jauh kepada Tuhan Yang Maha Esa. Kami percaya bahwa berinvestasi
